...
insert into public.inventory_units(id,organization_id,owner_business_unit_id,current_branch_id,brand_id,model_id,imei_1,serial_number,color,storage_capacity,ram_capacity,cost,cash_price,condition,mdm_compatible,status) values
('60000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','40000000-0000-0000-0000-000000000001','50000000-0000-0000-0000-000000000001','354000000000001','CC-IP15-001','Negro','128 GB','6 GB',18500,23990,'new',true,'available'),
('60000000-0000-0000-0000-000000000002','10000000-0000-0000-0000-000000000001','20000000-0000-0000-0000-000000000002','30000000-0000-0000-0000-000000000002','40000000-0000-0000-0000-000000000002','50000000-0000-0000-0000-000000000002','354000000000002','CC-S24-001','Gris','256 GB','8 GB',16000,21490,'new',true,'available');
insert into public.customers(id,organization_id,normalized_dni,first_name,last_name,phone,email,customer_type) values
('70000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','0801199012345','Ana','Martínez','9999-1001','ana.demo@example.com','returning_a'),
('70000000-0000-0000-0000-000000000002','10000000-0000-0000-0000-000000000001','0801199212346','Roberto','López','9999-1002','roberto.demo@example.com','new');
