...
const date = new Intl.DateTimeFormat("es-HN", { dateStyle: "medium", timeStyle: "short", timeZone: "America/Tegucigalpa" });
...
export default async function SubscriptionOperations({ searchParams }: {
  ...
  return <PlatformShell><div className="operations-page"><header className="operations-header"><div><span className="eyebrow">Operación interna</span><h1>Pagos y suscripciones</h1><p>Confirma únicamente después de comprobar el abono en el banco.</p></div><Link className="button secondary" href="/operacion">Volver al resumen</Link></header>
