# Accesos de demostración de CrediCel

Todos los usuarios internos usan la contraseña `CrediCel2026!`.
...
- Crédito activo.
- Crédito en mora con cuotas vencidas.
- Reporte de pago pendiente de validación.

Los datos son exclusivamente de demostración y no contienen información de clientes reales.
